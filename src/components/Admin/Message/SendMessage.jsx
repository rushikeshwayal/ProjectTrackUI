...
const SendMessage = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    sender_type: "admin", // Assuming sender type is admin
    receiver_id: "",
    receiver_type: "investigator",
    subject: "",
    body: "",
  });
  ...
  useEffect(() => {
    // Fetch all investigators from the API
        ...
        <div>
          ...
          >
            ...
            {investigators.map((investigator) => (
              <option key={investigator.investigatorUniqe_id} value={investigator.investigatorUniqe_id}>
                {investigator.investigator_name} - {investigator.investigatorUniqe_id}
              </option>
            ))}
          </select>
        </div>
